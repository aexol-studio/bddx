...
export const BoxWithSvg: React.FC<{
  ...
  const ReturnBubbles = (typeOfBubbles: "one" | "two" | "three") => {
    switch (typeOfBubbles) {
      ...
      case "three":
        return (
          <div className="top-[1.6rem] left-[50%] translate-x-[-50%] absolute">
            <CirclesThree />
          </div>
        );
    }
  ...
  return (
    <div className="select-none relative flex flex-col justify-center w-full max-w-[32.8rem]">
      ...
      <div className="rounded-[6px] bg-gradientBlue1 w-full min-h-[24.6rem] max-h-[24.6rem] md:min-h-[18.4rem] md:max-h-[18.4rem] flex justify-center items-center">
        {content.svg}
      </div>
