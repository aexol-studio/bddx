...
updateReport?: [{	uploadReportInput: ValueTypes["UpdateReportInput"] | Variable<any, string>},boolean | `@${string}`],
...
verifyEmail?: [{	verifyData: ValueTypes["VerifyEmailInput"] | Variable<any, string>},boolean | `@${string}`],
	...
	["CLIQuery"]: AliasType<{
getReport?: [{	reportId: string | Variable<any, string>},ValueTypes["TestReport"]],
getReports?: [{	projectKey: string | Variable<any, string>},ValueTypes["TestReport"]],
		__typename?: boolean | `@${string}`
}>;
	["User"]: AliasType<{
...
export type ResolverInputTypes = {
	...
	["CLIMutation"]: AliasType<{
updateReport?: [{	uploadReportInput: ResolverInputTypes["UpdateReportInput"]},boolean | `@${string}`],
...
verifyEmail?: [{	verifyData: ResolverInputTypes["VerifyEmailInput"]},boolean | `@${string}`],
	...
	["CLIQuery"]: AliasType<{
getReport?: [{	reportId: string},ResolverInputTypes["TestReport"]],
getReports?: [{	projectKey: string},ResolverInputTypes["TestReport"]],
		__typename?: boolean | `@${string}`
}>;
	["User"]: AliasType<{
	username?:boolean | `@${string}`,
